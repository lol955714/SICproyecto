...
from apps.registroCuentas.views import transaccion_list, transaccion_delete, editTransaccion, index, indext
...
urlpatterns = [
     ...
     url(r'^transaccion$', indext, name='index_transaccion'),
